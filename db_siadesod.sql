...
INDEX `fk_APPOINTMENT_PATIENT_idx` (`ID_PATIENT`) VISIBLE,
INDEX `fk_APPOINTMENT_DENTIST_idx` (`ID_DENTIST`) VISIBLE,
CONSTRAINT `fk_APPOINTMENT_PATIENT` FOREIGN KEY (`ID_PATIENT`) REFERENCES `PATIENT` (`ID_PATIENT`) ON DELETE CASCADE ON UPDATE NO ACTION,
CONSTRAINT `fk_APPOINTMENT_DENTIST` FOREIGN KEY (`ID_DENTIST`) REFERENCES `DENTIST` (`ID_DENTIST`) ON DELETE CASCADE ON UPDATE NO ACTION
);
...
INDEX `fk_TREATMENT_APPOINTMENT_idx` (`ID_APPOINTMENT`) VISIBLE,
